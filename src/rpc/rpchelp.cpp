...
void mc_InitRPCHelpMap01()
{
    ...
    mapHelpStrings.insert(std::make_pair("getblock",
            ...
            "\nResult (for verbose = 1, see help getrawtx for details about transactions - verbose = 4):\n"
            "{\n"
    ...
    mapHelpStrings.insert(std::make_pair("getblockchaininfo",
            ...
            "  \"protocol\": \"xxxx\",               (string) protocol - hdac \n"
...
void mc_InitRPCHelpMap03()
{
    ...
    mapHelpStrings.insert(std::make_pair("getgenerate",
            ...
            "It is set with the command line argument -gen (or hdac.conf setting gen)\n"
    ...
    mapHelpStrings.insert(std::make_pair("prioritisetx",
            "prioritisetx txid priority-delta fee-delta\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("prioritisetx", "\"txid\" 0.0 10000")
            + HelpExampleRpc("prioritisetx", "\"txid\", 0.0, 10000")
        ));

    it = mapHelpStrings.find("prioritisetx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("prioritisetransaction", strHelp));
    }
...
void mc_InitRPCHelpMap05()
{
    ...
    mapHelpStrings.insert(std::make_pair("createrawtx",
            "createrawtx [{\"txid\":\"id\",\"vout\":n},...] {\"address\":amount,...} ( [data] \"action\" ) \n"
            ...
            "\nExamples\n"
            + HelpExampleCli("createrawtx", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\" \"{\\\"address\\\":0.01}\"")
            + HelpExampleRpc("createrawtx", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\", \"{\\\"address\\\":0.01}\"")
        ));

    it = mapHelpStrings.find("createrawtx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("createrawtransaction", strHelp));
    }

    mapHelpStrings.insert(std::make_pair("decoderawtx",
            "decoderawtx \"tx-hex\"\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("decoderawtx", "\"hexstring\"")
            + HelpExampleRpc("decoderawtx", "\"hexstring\"")
        ));

    it = mapHelpStrings.find("decoderawtx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("decoderawtransaction", strHelp));
    }
    ...
    mapHelpStrings.insert(std::make_pair("getrawtx",
            ...
            "\nExamples:\n"
            + HelpExampleCli("getrawtx", "\"mytxid\"")
            + HelpExampleCli("getrawtx", "\"mytxid\" 1")
            + HelpExampleRpc("getrawtx", "\"mytxid\", 1")
        ));

    it = mapHelpStrings.find("getrawtx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("getrawtransaction", strHelp));
    }

    mapHelpStrings.insert(std::make_pair("sendrawtx",
            "sendrawtx \"tx-hex\" ( allowhighfees )\n"
            "\nSubmits raw transaction (serialized, hex-encoded) to local node and network.\n"
            "\nAlso see createrawtx and signrawtx calls.\n"
            "\nArguments:\n"
            "1. \"tx-hex\"                         (string, required) The hex string of the raw transaction)\n"
            ...
            + HelpExampleCli("createrawtx", "\"[{\\\"txid\\\" : \\\"mytxid\\\",\\\"vout\\\":0}]\" \"{\\\"myaddress\\\":0.01}\"") +
            "Sign the transaction, and get back the hex\n"
            + HelpExampleCli("sendrawtx", "\"myhex\"") +
            "\nSend the transaction (signed hex)\n"
            + HelpExampleCli("sendrawtx", "\"signedhex\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendrawtx", "\"signedhex\"")
        ));

    it = mapHelpStrings.find("sendrawtx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("sendrawtransaction", strHelp));
    }

    mapHelpStrings.insert(std::make_pair("signrawtx",
            "signrawtx \"tx-hex\" ( [{\"txid\":\"id\",\"vout\":n,\"scriptPubKey\":\"hex\",\"redeemScript\":\"hex\"},...] [\"privatekey1\",...] sighashtype )\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("signrawtx", "\"myhex\"")
            + HelpExampleRpc("signrawtx", "\"myhex\"")
        ));


    it = mapHelpStrings.find("signrawtx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("signrawtransaction", strHelp));
    }
    ...
    mapHelpStrings.insert(std::make_pair("createkeypairs",
            ...
            "      \"privkey\" : \"privatekey\",     (string) Private key, base58-encoded as required for signrawtx\n"
            "  }\n"
            "]\n"
            "\nExamples:\n"
...
//          "1. nblocks                          (numeric)\n"
            ...
            "                                    see minimum-relay-fee of params.dat\n"
            "\n"
...
void mc_InitRPCHelpMap07()
{
    ...
    mapHelpStrings.insert(std::make_pair("disablerawtx",
            "disablerawtx \"tx-hex\"\n"
            ...
            "\"transactionid\"                     (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("disablerawtx", "\"hexstring\"")
            + HelpExampleRpc("disablerawtx", "\"hexstring\"")
        ));

    it = mapHelpStrings.find("disablerawtx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("disablerawtransaction", strHelp));
    }
    ...
    mapHelpStrings.insert(std::make_pair("getaddresses",
            "getaddresses ( verbose address_type )\n"
            "\nReturns the list of all addresses in the wallet.\n"
            "\nArguments: \n"
            "1. verbose                          (boolean, optional, default=false) The account name.\n"
            "2. address_type                     (numeric, optional, default=0)\n"
            "                                    0=all 1=local address only 2=remote address only\n"
            "\nResult:\n"
            "[                                   (json array of )\n"
...
void mc_InitRPCHelpMap08()
{
    ...
    mapHelpStrings.insert(std::make_pair("getaddresstx",
            "getaddresstx \"address\" \"txid\" ( verbose )\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaddresstx", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
            + HelpExampleCli("getaddresstx", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\" true")
            + HelpExampleRpc("getaddresstx", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
        ));

    it = mapHelpStrings.find("getaddresstx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("getaddresstransaction", strHelp));
    }
    ...
    mapHelpStrings.insert(std::make_pair("getassettx",
            ...
            "\nExamples:\n"
            + HelpExampleCli("getassettx", "\"myasset\" \"mytxid\"")
            + HelpExampleCli("getassettx", "\"myasset\" \"mytxid\"  true")
            + HelpExampleRpc("getassettx", "\"myasset\", \"mytxid\", false")
        ));

    it = mapHelpStrings.find("getassettx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("getassettransaction", strHelp));
    }
...
void mc_InitRPCHelpMap09()
{
    ...
    mapHelpStrings.insert(std::make_pair("gettx",
            "gettx \"txid\" ( includeWatchonly )\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("gettx", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
            + HelpExampleCli("gettx", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\" true")
            + HelpExampleRpc("gettx", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
        ));

    it = mapHelpStrings.find("gettx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("gettransaction", strHelp));
    }
    ...
    mapHelpStrings.insert(std::make_pair("getwallettx",
            "getwallettx \"txid\" ( includeWatchonly verbose )\n"
            "\nGet detailed information about in-wallet transaction <txid>\n"
            "\nArguments:\n"
            "1. \"txid\"    (string, required) The transaction id\n"
            "2. includeWatchonly    (bool, optional, default=false) Whether to include watchonly addresses in balance calculation and details[]\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("getwallettx", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
            + HelpExampleCli("getwallettx", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\" true")
            + HelpExampleRpc("getwallettx", "\"1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d\"")
        ));

    it = mapHelpStrings.find("getwallettx");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("getwallettransaction", strHelp));
    }
    ...
    mapHelpStrings.insert(std::make_pair("grant",
            ...
            "                                                        or per-stream: stream-identifier.write,activate,admin,getstatus,control,execute \n"
            ...
            "\"transactionid\"                     (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("grant", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" connect,send,receive 0.1 ")
            + HelpExampleCli("grant", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" mystream.admin,write 0.1 " )
            + HelpExampleCli("grant", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" mine 0.1 0 4294967295 \"permission to mine\" \"Miners Ltd.\"")
            + HelpExampleRpc("grant", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" admin 0.1 20000 30000 \"temporary admin\" \"Admins Ltd.\" ")
        ));
    ...
    mapHelpStrings.insert(std::make_pair("grantfrom",
            ...
            "\"transactionid\"                     (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("grantfrom", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" connect,send,receive 0.1 ")
            + HelpExampleCli("grantfrom", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" mine 0.1 0 4294967295 \"permission to mine\" \"Miners Ltd.\"")
            + HelpExampleRpc("grantfrom", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\", \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\", admin 0.1 20000 30000 \"temporary admin\" \"Admins Ltd.\" ")
        ));
...
void mc_InitRPCHelpMap11()
{
    ...
    mapHelpStrings.insert(std::make_pair("listaddresstxs",
            "listaddresstxs \"address\" ( count skip verbose )\n"
            ...
            + HelpExampleCli("listaddresstxs", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"") +
            "\nList transactions 100 to 120 \n"
            + HelpExampleCli("listaddresstxs", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" 20 100") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("listaddresstxs", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\", 20, 100")
        ));

    it = mapHelpStrings.find("listaddresstxs");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("listaddresstransactions", strHelp));
    }

    mapHelpStrings.insert(std::make_pair("listassettxs",
             "listassettxs \"asset-identifier\" ( verbose count start local-ordering )\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("listassettxs", "\"test-asset\"")
            + HelpExampleCli("listassettxs", "\"test-asset\" true 10 100")
            + HelpExampleRpc("listassettxs", "\"test-asset\", false, 20")
       ));

    it = mapHelpStrings.find("listassettxs");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("listassettransactions", strHelp));
    }
...
void mc_InitRPCHelpMap12()
{
    ...
    mapHelpStrings.insert(std::make_pair("listtxs",
            "listtxs ( \"account\" count from includeWatchonly )\n"
            ...
            "\nExamples:\n"
            "\nList the most recent 10 transactions in the systems\n"
            + HelpExampleCli("listtxs", "") +
            "\nList the most recent 10 transactions for the tabby account\n"
            + HelpExampleCli("listtxs", "\"tabby\"") +
            "\nList transactions 100 to 120 from the tabby account\n"
            + HelpExampleCli("listtxs", "\"tabby\" 20 100") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("listtxs", "\"tabby\", 20, 100")
        ));
    ...
    mapHelpStrings.insert(std::make_pair("listwallettxs",
            "listwallettxs ( count skip includeWatchonly verbose )\n"
            ...
            "\nExamples:\n"
            "\nList the most recent 10 transactions in the systems\n"
            + HelpExampleCli("listwallettxs", "") +
            "\nList transactions 100 to 120 \n"
            + HelpExampleCli("listwallettxs", "20 100") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("listwallettxs", "20, 100")
        ));

    it = mapHelpStrings.find("listwallettxs");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("listwallettransactions", strHelp));
    }
...
void mc_InitRPCHelpMap13()
{
    ...
    mapHelpStrings.insert(std::make_pair("resendwallettxs",
            "resendwallettransactions\n"
            "\nStop Resends wallet transactions."
        ));

    it = mapHelpStrings.find("resendwallettxs");
    if (it != mapHelpStrings.end())
    {
        strHelp=it->second;
        mapHelpStrings.insert(std::make_pair("resendwallettransactions", strHelp));
    }
    ...
    mapHelpStrings.insert(std::make_pair("revoke",
            ...
            "\"transactionid\"                     (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("revoke", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" connect,send,receive ")
            + HelpExampleCli("revoke", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" mine ")
            + HelpExampleRpc("revoke", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" admin ")
        ));
    ...
    mapHelpStrings.insert(std::make_pair("revokefrom",
            ...
            "\"transactionid\"                     (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("revokefrom", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" connect,send,receive")
            + HelpExampleCli("revokefrom", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" mine ")
            + HelpExampleRpc("revokefrom", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" admin")
        ));
...
void mc_InitRPCHelpMap16()
{
    ...
    mapHelpStrings.insert(std::make_pair("appendrawtx",
            ...
            "\nExamples\n"
            + HelpExampleCli("appendrawtx", "\"hexstring\" \"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\" \"{\\\"address\\\":0.01}\"")
            + HelpExampleRpc("appendrawtx", "\"hexstring\", \"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\", \"{\\\"address\\\":0.01}\"")
        ));
    ...
    mapHelpStrings.insert(std::make_pair("listblocks",
            ...
            "    }\n"
            "2. verbose                          (numeric or boolean, optional, default=0)\n"
	    "                                        0(or false) - encoded data, 1(or true) - json object,\n"
            "                                        2 - with tx encoded data, 4 - with tx json object\n"
            "\nResult (for verbose = 1, see help getrawtx for details about transactions - verbose = 4):\n"
            "{\n"
            "  \"hash\" : \"hash\",                  (string) the block hash (same as provided)\n"
...
void mc_InitRPCLogParamCountMap()
{
    ...
    mapLogParamCounts.insert(std::make_pair("signrawtx",-1));
...
void mc_InitRPCAllowedWhenWaitingForUpgradeSet()
{
    ...
    setAllowedWhenWaitingForUpgrade.insert("decoderawtx");
    setAllowedWhenWaitingForUpgrade.insert("decoderawtransaction");
    setAllowedWhenWaitingForUpgrade.insert("getrawtx");
...
void mc_InitRPCAllowedWhenOffline()
{
    ...
    setAllowedWhenOffline.insert("signrawtx");

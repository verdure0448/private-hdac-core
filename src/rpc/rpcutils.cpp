...
// 2018/02/00	FEATURE_HDAC_EXTENDED_PERMISSIONS added
//============================================================================================
    ...
    for (int e = 0; e < lpScript->GetNumElements(); e++)
    {
        ...
        else                                                        // Not entity element
        {
            ...
            {                
                ...
                if(full_type & MC_PTP_GETSTAT)entry.push_back(Pair("getstatus", (type & MC_PTP_GETSTAT) ? true : false));
                if(full_type & MC_PTP_CONTROL)entry.push_back(Pair("control", (type & MC_PTP_CONTROL) ? true : false));
                if(full_type & MC_PTP_EXECUTE)entry.push_back(Pair("execute", (type & MC_PTP_EXECUTE) ? true : false));

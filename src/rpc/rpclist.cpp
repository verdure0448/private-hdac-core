...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "wallet",             "gettx",                  &gettransaction,         false,     false,      true },
    ...
    { "wallet",             "listtxs",                &listtransactions,       false,     false,      true },
    ...
    { "wallet",             "listwallettxs",          &listwallettransactions, false,     false,      true },
    { "wallet",             "listwallettransactions", &listwallettransactions, false,     false,      true },
    { "wallet",             "listaddresstxs",         &listaddresstransactions,false,     false,      true },
    { "wallet",             "listaddresstransactions",&listaddresstransactions,false,     false,      true },
    { "wallet",             "getwallettx",            &getwallettransaction,   false,     false,      true },
    { "wallet",             "getwallettransaction",   &getwallettransaction,   false,     false,      true },
    { "wallet",             "getaddresstx",           &getaddresstransaction,  false,     false,      true },
...
//  { "network",            "ping",                   &ping,                   true,      false,      false },
    ...
    { "mining",             "prioritisetx",           &prioritisetransaction,  true,      false,      false },
    { "mining",             "prioritisetransaction",  &prioritisetransaction,  true,      false,      false },
    { "mining",             "submitblock",            &submitblock,            true,      true,       false },
    { "mining",             "getblockwindowsize",     &getblockwindowsize,     true,      false,      false },
#ifdef ENABLE_WALLET
    /* Coin generation */
    ...
    /* Raw transactions */
    { "rawtransactions",    "appendrawtx",            &appendrawtransaction,   true,      false,      false },
    { "rawtransactions",    "appendrawtransaction",   &appendrawtransaction,   true,      false,      false },
    { "rawtransactions",    "createrawtx",            &createrawtransaction,   true,      false,      false },
    { "rawtransactions",    "createrawtransaction",   &createrawtransaction,   true,      false,      false },
    { "rawtransactions",    "decoderawtx",            &decoderawtransaction,   true,      false,      false },
    { "rawtransactions",    "decoderawtransaction",   &decoderawtransaction,   true,      false,      false },
    { "rawtransactions",    "decodescript",           &decodescript,           true,      false,      false },
    { "rawtransactions",    "getrawtx",               &getrawtransaction,      true,      false,      false },
    { "rawtransactions",    "getrawtransaction",      &getrawtransaction,      true,      false,      false },
    { "rawtransactions",    "sendrawtx",              &sendrawtransaction,     false,     false,      false },
    { "rawtransactions",    "sendrawtransaction",     &sendrawtransaction,     false,     false,      false },
    { "rawtransactions",    "signrawtx",              &signrawtransaction,     false,     false,      false }, /* uses wallet if enabled */
...
//  { "wallet",             "sendfrom",               &sendfrom,               false,     false,      true },
    ...
    { "wallet",             "getmultibalances",       &getmultibalances,       false,     false,      true },
    { "wallet",             "getaddressbalances",     &getaddressbalances,     false,     false,      true },
    { "wallet",             "disablerawtx",           &disablerawtransaction,  false,     false,      true },
    ...
    { "wallet",             "getaddresstx",           &getaddresstransaction,  false,     false,      true },
    { "wallet",             "getaddresstransaction",  &getaddresstransaction,  false,     false,      true },
    { "wallet",             "resendwallettxs",        &resendwallettransactions, false,   false,      true },
    ...
    { "wallet",             "listassettxs",           &listassettransactions,  false,     false,      true },
    { "wallet",             "listassettransactions",  &listassettransactions,  false,     false,      true },
    { "wallet",             "getassettx",             &getassettransaction,    false,     false,      true },

...
#define MC_PTP_GETSTAT          0x00000200	// Get device status. 
#define MC_PTP_CONTROL          0x00000400	// Device control. 
#define MC_PTP_EXECUTE          0x00000800	// Execute IoT Contract. 
...
// External functions    
    ...
    int CanGetStat(const void* lpEntity,const void* lpAddress);
    int CanControl(const void* lpEntity,const void* lpAddress);
    int CanExecute(const void* lpEntity,const void* lpAddress);

...
const int   HDAC_TARGET_BLOCK_TIME_MULTIPLE = 20;		// blackouttime change (9min --> 60min)
...
bool VerifyBlockWindow(const CBlock& block, CNode* pfrom)
{
    ...
    if(pfrom != NULL && diffBlkTime > (MCP_TARGET_BLOCK_TIME*HDAC_TARGET_BLOCK_TIME_MULTIPLE))   
    {
        if(fDebug>0)
        {

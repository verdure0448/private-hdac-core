...
//      vSeeds.push_back(CDNSSeedData("seed.as.hdactech.com", "dns.as.hdactech.com"));
//      vSeeds.push_back(CDNSSeedData("seed.us.hdactech.com", "dns.us.hdactech.com"));
//      vSeeds.push_back(CDNSSeedData("seed.eu.hdactech.com", "dns.eu.hdactech.com"));
...
public:
	...
	// TODO currently copied from main, decide what to do with it later.
//      base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x04)(0x35)(0x87)(0xCF);
//      base58Prefixes[EXT_SECRET_KEY] = list_of(0x04)(0x35)(0x83)(0x94);

...
#ifndef __HDAC_PARAMLIST_H_
#define __HDAC_PARAMLIST_H_
...
static const mc_OneHdacParam HdacParamArray[] =
{
    {"chainprotocol", "chain-protocol",
        ...
        "Chain protocol: hdac (permissions, native assets)"},
    ...
    {"kasseasm", "kasse-asm",
        MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE, -1,         0,          0,         0, 0.0, 10001, 0, "",
        "anyonecanconnect", "",
        "Hdac Kasse H/W ASM(Advanced Security Module) device support."},
#else
    {"defaultrpcport", "default-rpc-port",
        MC_PRM_UINT32  | MC_PRM_GENERATED | MC_PRM_CLONE | MC_PRM_MINIMAL, -1, MC_DEFAULT_RPC_PORT,       1024,     65535, 0.0, 10001, 0, "-mc-defaultrpcport",
        "anyonecanconnect","",
